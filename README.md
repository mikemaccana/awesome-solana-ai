...
- [solana-anchor-claude-skill](https://github.com/mikemaccana/solana-anchor-claude-skill) - this is used in production at Quicknode and based on the theory that [most AI tools output poor quality Solana code](https://youtu.be/QcinP8mGWxg). End to end Solana development for Anchor and Solana Kit, specifically focused on modern, minimal, readable code using 2026 tooling. Testing is with native JS test runners or LiteSVM.
